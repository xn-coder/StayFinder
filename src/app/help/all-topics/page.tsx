                ...
                <h1 className="text-2xl font-semibold">Help Centre</h1>
                 <div className="relative w-full max-w-sm">
                    ...
                    <Input 
                      ...
                      className="h-12 pl-12 rounded-full text-base border border-primary/30 shadow-sm hover:shadow-md transition-shadow focus-visible:ring-1 focus-visible:ring-ring"
                      value={searchTerm}
