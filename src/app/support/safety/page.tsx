            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-4">
                <div className="bg-background rounded-xl rounded-tl-none p-4 shadow-sm border w-fit max-w-md">
                  <p className="font-semibold mb-1 text-primary">StayFinder Support</p>
                  <p>
                ...
                <div className="bg-background rounded-xl rounded-tl-none p-4 shadow-sm border w-fit max-w-md">
                  <p>
                    If you need help from StayFinder, select the issue you’re experiencing. This info helps us get you to the right person faster.
                  </p>
                </div>
